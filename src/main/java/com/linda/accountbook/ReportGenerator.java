...
public class ReportGenerator {
    ...
    private void showCategoryDistribution(int year, int month, AccountBook accountBook) {
        ...
        // 显示简单条形图
        showSimpleBarChart(expenseSummary);
    }

    // 显示简单条形图
    private void showSimpleBarChart(Map<String, Double> data) {
        ...
        for (Map.Entry<String, Double> entry : data.entrySet()) {
            ...
            System.out.printf("%-6s: %-40s ¥%.2f\n", category, bar.toString(), value);
        }
    }
